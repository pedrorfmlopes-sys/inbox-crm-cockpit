...
const S: Record<string, React.CSSProperties> = {
  ...
  modalSheet: { background: "var(--skin-bg-main, #ffffff)", color: "var(--skin-text-main, #000000)", border: "1px solid var(--skin-border-main, #e5e7eb)", borderRadius: 12, width: "100%", maxWidth: 500, maxHeight: "90vh", display: "flex", flexDirection: "column", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04)" },
  modalHeader: { padding: "16px 20px", borderBottom: "1px solid var(--skin-border-main, #e5e7eb)", display: "flex", justifyContent: "space-between", alignItems: "flex-start" },
  kicker: { fontSize: 10, fontWeight: 700, color: "var(--skin-accent-main, #1d4ed8)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 2 },
  modalTitle: { fontSize: 18, fontWeight: 700, color: "var(--skin-text-main, #000000)" },
  modalScopeRow: { padding: "12px 20px", display: "flex", gap: 8, background: "var(--skin-bg-muted, #f3f4f6)", borderBottom: "1px solid var(--skin-border-main, #e5e7eb)" },
  scopeChip: { flex: 1, padding: "8px 4px", fontSize: 11, borderRadius: 6, border: "1px solid var(--skin-border-main, #e5e7eb)", background: "var(--skin-bg-main, #ffffff)", color: "var(--skin-text-muted, #6b7280)", cursor: "pointer", fontWeight: 500 },
  scopeChipOn: { flex: 1, padding: "8px 4px", fontSize: 11, borderRadius: 6, border: "1px solid var(--skin-accent-main, #1d4ed8)", background: "var(--skin-bg-active, #eff6ff)", color: "var(--skin-accent-main, #1d4ed8)", cursor: "pointer", fontWeight: 600 },
  ...
  editorBlockTitle: { fontSize: 11, fontWeight: 700, color: "var(--skin-text-muted, #6b7280)", textTransform: "uppercase" },
  linkBtn: { background: "none", border: "none", padding: 0, color: "var(--skin-accent-main, #1d4ed8)", fontSize: 11, cursor: "pointer", textDecoration: "underline" },
  applySingleEmailSummary: { padding: 12, borderRadius: 8, border: "1px solid var(--skin-border-main, #e5e7eb)", background: "var(--skin-bg-muted, #f3f4f6)" },
  applyEmailSummaryHead: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8 },
  applyEmailSummaryTitle: { fontSize: 13, fontWeight: 600, color: "var(--skin-text-main, #000000)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  applyEmailSummaryMeta: { fontSize: 11, color: "var(--skin-text-muted, #6b7280)", marginTop: 2 },
  applyEmailPreview: { fontSize: 11, color: "var(--skin-text-muted, #6b7280)", background: "var(--skin-bg-main, #ffffff)", padding: 10, borderRadius: 6, border: "1px solid var(--skin-border-main, #e5e7eb)", marginTop: 8, lineHeight: "1.4" },
  applyEmailList: { display: "flex", flexDirection: "column", gap: 6 },
  applyEmailRow: { padding: "8px 12px", borderRadius: 8, border: "1px solid var(--skin-border-main, #e5e7eb)", background: "var(--skin-bg-main, #ffffff)" },
  applyEmailRowOn: { padding: "8px 12px", borderRadius: 8, border: "1px solid var(--skin-accent-main, #1d4ed8)", background: "var(--skin-bg-active, #eff6ff)" },
  ...
  applyScopeBadge: { fontSize: 9, fontWeight: 700, padding: "2px 6px", borderRadius: 4, background: "var(--skin-bg-muted, #f3f4f6)", color: "var(--skin-text-muted, #6b7280)" },
  applyScopeBadgeOn: { fontSize: 9, fontWeight: 700, padding: "2px 6px", borderRadius: 4, background: "var(--skin-bg-success-muted, #d1fae5)", color: "var(--skin-bg-success, #10b981)" },
  applyEmailSubject: { fontSize: 12, fontWeight: 500, color: "var(--skin-text-main, #000000)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  applyEmailRowTail: { display: "flex", alignItems: "center", gap: 8, flexShrink: 0 },
  applyEmailMeta: { fontSize: 11, color: "var(--skin-text-muted, #6b7280)" },
  chevronBtn: { background: "none", border: "none", width: 24, height: 24, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "var(--skin-text-muted, #6b7280)", fontSize: 14 },
  modalFooter: { padding: "16px 20px", borderTop: "1px solid var(--skin-border-main, #e5e7eb)", display: "flex", gap: 10, alignItems: "center", background: "var(--skin-bg-muted, #f3f4f6)", borderBottomLeftRadius: 12, borderBottomRightRadius: 12 },
  primaryBtn: { padding: "10px 16px", fontSize: 13, fontWeight: 600, borderRadius: 8, background: "var(--skin-accent-main, #1d4ed8)", color: "white", border: "none", cursor: "pointer" },
  secondaryBtn: { padding: "10px 16px", fontSize: 13, fontWeight: 600, borderRadius: 8, background: "var(--skin-bg-main, #ffffff)", color: "var(--skin-text-main, #000000)", border: "1px solid var(--skin-border-main, #e5e7eb)", cursor: "pointer" },
};
